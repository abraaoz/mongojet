...
@pytest.mark.asyncio
async def test_insert_one(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_insert_many(db: Database) -> None:
    ...
    for doc in docs:
        _id = doc["_id"]  # type:ignore[assignment]
...
@pytest.mark.asyncio
async def test_insert_error(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_insert_with_validation(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_replace_one(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_update_one(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_update_many(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_find_and_modify(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_delete_one(db: Database) -> None:
...
@pytest.mark.asyncio
async def test_delete_many(db: Database) -> None:
